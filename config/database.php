...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Shop Catalog support system: a physically separate PostgreSQL database
        // (see App\Models\ShopCatalog) that still needs to be searchable from the
        // main CRM's product search — that integration reads via this connection.
        'shop_catalog' => [
            'driver' => 'pgsql',
            'url' => env('SHOP_DATABASE_URL'),
            'host' => env('SHOP_DB_HOST', '127.0.0.1'),
            'port' => env('SHOP_DB_PORT', '5432'),
            'database' => env('SHOP_DB_DATABASE', 'favala_shop_catalog'),
