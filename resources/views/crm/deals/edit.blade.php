<div>
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('crm.deals.show', $record) }}" class="text-zinc-400 hover:text-white"><x-heroicon-o-arrow-left class="w-5 h-5" /></a>
    ...
    <form wire:submit.prevent="save" class="max-w-2xl space-y-6">
        ...
        <div class="flex justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('crm.deals.show', $record) }}" class="px-4 py-2 rounded-lg border border-white/10 text-zinc-300 text-sm">Cancel</a>
