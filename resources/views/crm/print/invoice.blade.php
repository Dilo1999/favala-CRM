    ...
    <div class="print-frame w-[148mm] mx-auto bg-white text-[10px] border-[3px] border-black rounded-xl p-4">
            ...
            <tbody>
                ...
                @foreach ($record->items as $i => $item)
                    ...
                    <tr class="border-b border-gray-100">
                        ...
                        <td class="py-px px-1 text-right text-gray-800">{{ rtrim(rtrim(number_format($remainingQty, 2), '0'), '.') }} {{ $item->product?->unit_of_measure }}</td>
                        ...
                        <td class="py-px px-1 text-right text-blue-800 font-medium">{{ number_format($remainingAmount, 2) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div class="flex justify-end mb-2">
            <div class="w-36 space-y-0.5">
                <div class="flex justify-between"><span class="text-gray-700">Sub Total:</span><span class="text-blue-800">MVR {{ number_format($totals['subtotal'], 2) }}</span></div>
                ...
                <div class="flex justify-between font-bold text-[11px] border-t border-gray-300 pt-0.5"><span>Total:</span><span>MVR {{ number_format($totals['grand_total'], 2) }}</span></div>
